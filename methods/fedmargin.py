...
#        wandb.watch(self.model)
    ...
    def operations(self, client_info):
        ...
        return [(self.model.cpu().state_dict(), delta, linear.margin) for _ in range(self.args.thread_number)]
    ...
    def start(self):
        ...
        return [(self.model.cpu().state_dict(), delta, 1) for _ in range(self.args.thread_number)]